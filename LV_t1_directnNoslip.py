                ...
                for dx, dy in [(-1, 0), (1, 0), (0, -1), (0, 1)]:
                    ...
                    if 0 <= nx < env.width and 0 <= ny < env.height:
                        ...
                        if cell is None or (cell.type != 'wall'): 
                            ...
                            env.agent_pos = (nx, ny)
                            obs_neigh = env.gen_obs()['image']
                            valid_neighbors.append(obs_neigh)
...
MODEL_PATH = "storage/randomenv_ranreward_16_directnNoslip/status.pt" 
CERTI_PATH = "certis/certificate_16x16_directnNoslip.pt"
